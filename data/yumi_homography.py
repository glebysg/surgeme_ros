...
def main():
    ...
    for i in range(12):
        arm_pose_left = pkl.load( open( "data/homography_backup/poses_left_%s" % str(i+1), "rb" ) )
        arm_pose_right = pkl.load( open( "data/homography_backup/poses_right_%s" % str(i+1), "rb" ) )
